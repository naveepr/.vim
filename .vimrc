...
source $HOME/.vim/plug-config/SimpylFold.vim
source $HOME/.vim/plug-config/taglist.vim
...
"lua-config
"luafile $HOME/.vim/lua/plugins/compe-config.lua
"luafile $HOME/.vim/lua/lsp/python-ls.lua
